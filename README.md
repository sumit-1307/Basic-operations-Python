...
Task 2 : Personalized Greeting for a user
  ...
  >Taking Last name as input from user.
  >concating the two strings with a empty space in between to create a full name.
  >printing a personalized greeting message by using the custom name.
